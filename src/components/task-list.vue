...
.tasks-list {
  display: grid;
  grid-template-columns: repeat(5, 1fr); /* 5 столбцов на больших экранах */
...
@media (max-width: 1024px) {
  .tasks-list {
    grid-template-columns: repeat(3, 1fr); /* 3 столбца на планшетах */
  }
}
...
@media (max-width: 600px) {
  ...
  .custom-task-button {
    ...
    margin: 0.25rem; /* Уменьшаем отступы */
  }
}
...
@media (max-width: 400px) {
  .tasks-list {
    grid-template-columns: repeat(1, 1fr); /* 1 столбец на очень маленьких экранах */
  }
}
</style>